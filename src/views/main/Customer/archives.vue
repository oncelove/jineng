<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%"  class="table-box">
            ...
            <el-table-column fixed prop="agentId" label="agentId"></el-table-column>
            ...
            <el-table-column prop="documentId" label="documentId"></el-table-column>
            <el-table-column prop="documentName" label="documentName"></el-table-column>
            <el-table-column prop="documentType" label="documentType"></el-table-column>
            <el-table-column prop="endTime" label="endTime"></el-table-column>
            <el-table-column prop="ossUrl" label="ossUrl"></el-table-column>
        ...
        <el-dialog title="档案管理信息" :visible.sync="dialogTableVisible">
            <el-table :data="dialogData">
                <el-table-column property="documentId" label="documentId" width="150"></el-table-column>
                <el-table-column property="documentName" label="documentName" width="200"></el-table-column>
                <el-table-column property="ossUrl" label="ossUrl"></el-table-column>
            </el-table>
        </el-dialog>
    </div>
</template>
