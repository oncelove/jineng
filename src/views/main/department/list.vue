    ...
    <div>
        ...
        <el-dialog title="部门管理信息" :visible.sync="dialogTableVisible">
            <el-table :data="dialogData">
                <el-table-column property="departmentId" label="departmentId" width="150"></el-table-column>
                <el-table-column property="agentName" label="agentName" width="200"></el-table-column>
